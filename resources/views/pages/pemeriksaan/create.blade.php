...
@section('content')
    ...
    <div class="page-header">
        <div class="page-title">
            <h4>Tambah Pemeriksaan Balita</h4>
            <h6>Create new Pemeriksaan</h6>
        </div>
    </div>
            ...
            <form action="{{ route('pemeriksaan.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <x-form.input-text readonly={{ true }} class="col-sm-6" type="number" label="Usia Bulan"
                        name="age_months" placeholder="Usia Bulan" />
                    ...
                    <!-- Linkaran Kepala -->
                    <x-form.input-text class="col-sm-6" type="number" label="Lingkaran Kepala" name="head_circumference"
                        placeholder="Masukkan Ukuran  Lingkaran Kepala" required />
                    ...
                    <div class="col-sm-6 mb-3">
                        ...
                        <textarea name="notes" id="notes" class="form-control" rows="3" placeholder="Masukkan Catatan">{{ old('notes') }}</textarea>
                    </div>
